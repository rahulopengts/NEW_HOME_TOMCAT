...
* generated by Xtext
*/
package org.openhab.model.rule.ui.contentassist.antlr;
...
public class RulesParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.openhab.model.rule.ui.contentassist.antlr.internal.InternalRulesParser createParser() {
		org.openhab.model.rule.ui.contentassist.antlr.internal.InternalRulesParser result = new org.openhab.model.rule.ui.contentassist.antlr.internal.InternalRulesParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getRuleAccess().getNameAlternatives_1_0(), "rule__Rule__NameAlternatives_1_0");
					put(grammarAccess.getEventTriggerAccess().getAlternatives(), "rule__EventTrigger__Alternatives");
					put(grammarAccess.getTimerTriggerAccess().getAlternatives(), "rule__TimerTrigger__Alternatives");
					put(grammarAccess.getTimerTriggerAccess().getTimeAlternatives_1_2_0(), "rule__TimerTrigger__TimeAlternatives_1_2_0");
					put(grammarAccess.getSystemTriggerAccess().getAlternatives(), "rule__SystemTrigger__Alternatives");
					put(grammarAccess.getValidStateAccess().getAlternatives(), "rule__ValidState__Alternatives");
					put(grammarAccess.getValidCommandAccess().getAlternatives(), "rule__ValidCommand__Alternatives");
					...
					put(grammarAccess.getCommandEventTriggerAccess().getGroup(), "rule__CommandEventTrigger__Group__0");
					put(grammarAccess.getUpdateEventTriggerAccess().getGroup(), "rule__UpdateEventTrigger__Group__0");
					put(grammarAccess.getChangedEventTriggerAccess().getGroup(), "rule__ChangedEventTrigger__Group__0");
					put(grammarAccess.getChangedEventTriggerAccess().getGroup_3(), "rule__ChangedEventTrigger__Group_3__0");
					put(grammarAccess.getChangedEventTriggerAccess().getGroup_4(), "rule__ChangedEventTrigger__Group_4__0");
					put(grammarAccess.getTimerTriggerAccess().getGroup_0(), "rule__TimerTrigger__Group_0__0");
					put(grammarAccess.getTimerTriggerAccess().getGroup_1(), "rule__TimerTrigger__Group_1__0");
					put(grammarAccess.getSystemOnStartupTriggerAccess().getGroup(), "rule__SystemOnStartupTrigger__Group__0");
					put(grammarAccess.getSystemOnShutdownTriggerAccess().getGroup(), "rule__SystemOnShutdownTrigger__Group__0");
					...
					put(grammarAccess.getScriptAccess().getGroup_2(), "rule__Script__Group_2__0");
					...
					put(grammarAccess.getRuleModelAccess().getImportsAssignment_0(), "rule__RuleModel__ImportsAssignment_0");
					put(grammarAccess.getRuleModelAccess().getVariablesAssignment_1(), "rule__RuleModel__VariablesAssignment_1");
					put(grammarAccess.getRuleModelAccess().getRulesAssignment_2(), "rule__RuleModel__RulesAssignment_2");
					put(grammarAccess.getImportAccess().getImportedNamespaceAssignment_1(), "rule__Import__ImportedNamespaceAssignment_1");
					put(grammarAccess.getRuleAccess().getNameAssignment_1(), "rule__Rule__NameAssignment_1");
					put(grammarAccess.getRuleAccess().getEventtriggerAssignment_3(), "rule__Rule__EventtriggerAssignment_3");
					put(grammarAccess.getRuleAccess().getEventtriggerAssignment_4_1(), "rule__Rule__EventtriggerAssignment_4_1");
					put(grammarAccess.getRuleAccess().getScriptAssignment_6(), "rule__Rule__ScriptAssignment_6");
					put(grammarAccess.getCommandEventTriggerAccess().getItemAssignment_1(), "rule__CommandEventTrigger__ItemAssignment_1");
					put(grammarAccess.getCommandEventTriggerAccess().getCommandAssignment_3(), "rule__CommandEventTrigger__CommandAssignment_3");
					put(grammarAccess.getUpdateEventTriggerAccess().getItemAssignment_1(), "rule__UpdateEventTrigger__ItemAssignment_1");
					put(grammarAccess.getUpdateEventTriggerAccess().getStateAssignment_3(), "rule__UpdateEventTrigger__StateAssignment_3");
					put(grammarAccess.getChangedEventTriggerAccess().getItemAssignment_1(), "rule__ChangedEventTrigger__ItemAssignment_1");
					put(grammarAccess.getChangedEventTriggerAccess().getOldStateAssignment_3_1(), "rule__ChangedEventTrigger__OldStateAssignment_3_1");
					put(grammarAccess.getChangedEventTriggerAccess().getNewStateAssignment_4_1(), "rule__ChangedEventTrigger__NewStateAssignment_4_1");
					put(grammarAccess.getTimerTriggerAccess().getCronAssignment_0_2(), "rule__TimerTrigger__CronAssignment_0_2");
					put(grammarAccess.getTimerTriggerAccess().getTimeAssignment_1_2(), "rule__TimerTrigger__TimeAssignment_1_2");
					put(grammarAccess.getScriptAccess().getExpressionsAssignment_1(), "rule__Script__ExpressionsAssignment_1");
					put(grammarAccess.getScriptAccess().getExpressionsAssignment_2_0(), "rule__Script__ExpressionsAssignment_2_0");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.openhab.model.rule.ui.contentassist.antlr.internal.InternalRulesParser typedParser = (org.openhab.model.rule.ui.contentassist.antlr.internal.InternalRulesParser) parser;
