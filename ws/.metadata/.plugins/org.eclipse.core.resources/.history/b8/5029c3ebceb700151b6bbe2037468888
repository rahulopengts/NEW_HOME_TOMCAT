		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getItemModelAccess().getGroup(), "rule__ItemModel__Group__0");
					...
					put(grammarAccess.getItemModelAccess().getItemsAssignment_1(), "rule__ItemModel__ItemsAssignment_1");
