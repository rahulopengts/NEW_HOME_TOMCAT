...
(
    ...
    { 
        $current = $this_UpdateEventTrigger_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_CommandEventTrigger_1.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_ChangedEventTrigger_2.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_TimerTrigger_3.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_SystemTrigger_4.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleCommandEventTrigger returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getCommandEventTriggerRule()); }
	 iv_ruleCommandEventTrigger=ruleCommandEventTrigger 
	 { $current=$iv_ruleCommandEventTrigger.current; } 
	 EOF 
;

// Rule CommandEventTrigger
ruleCommandEventTrigger returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='Item' 
...
entryRuleUpdateEventTrigger returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getUpdateEventTriggerRule()); }
	 iv_ruleUpdateEventTrigger=ruleUpdateEventTrigger 
	 { $current=$iv_ruleUpdateEventTrigger.current; } 
	 EOF 
;

// Rule UpdateEventTrigger
ruleUpdateEventTrigger returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='Item' 
...
entryRuleChangedEventTrigger returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getChangedEventTriggerRule()); }
	 iv_ruleChangedEventTrigger=ruleChangedEventTrigger 
	 { $current=$iv_ruleChangedEventTrigger.current; } 
	 EOF 
;

// Rule ChangedEventTrigger
ruleChangedEventTrigger returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='Item' 
...
entryRuleTimerTrigger returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getTimerTriggerRule()); }
	 iv_ruleTimerTrigger=ruleTimerTrigger 
	 { $current=$iv_ruleTimerTrigger.current; } 
	 EOF 
;

// Rule TimerTrigger
ruleTimerTrigger returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((	otherlv_0='Time' 
...
entryRuleSystemTrigger returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSystemTriggerRule()); }
	 iv_ruleSystemTrigger=ruleSystemTrigger 
	 { $current=$iv_ruleSystemTrigger.current; } 
	 EOF 
;

// Rule SystemTrigger
ruleSystemTrigger returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    ...
    { 
        $current = $this_SystemOnStartupTrigger_0.current; 
        afterParserOrEnumRuleCall();
    }
    ...
    { 
        $current = $this_SystemOnShutdownTrigger_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleSystemOnStartupTrigger returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSystemOnStartupTriggerRule()); }
	 iv_ruleSystemOnStartupTrigger=ruleSystemOnStartupTrigger 
	 { $current=$iv_ruleSystemOnStartupTrigger.current; } 
	 EOF 
;

// Rule SystemOnStartupTrigger
ruleSystemOnStartupTrigger returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleSystemOnShutdownTrigger returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getSystemOnShutdownTriggerRule()); }
	 iv_ruleSystemOnShutdownTrigger=ruleSystemOnShutdownTrigger 
	 { $current=$iv_ruleSystemOnShutdownTrigger.current; } 
	 EOF 
;

// Rule SystemOnShutdownTrigger
ruleSystemOnShutdownTrigger returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleItemName returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getItemNameRule()); } 
	 iv_ruleItemName=ruleItemName 
	 { $current=$iv_ruleItemName.current.getText(); }  
	 EOF 
;

// Rule ItemName
ruleItemName returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
    this_ID_0=RULE_ID    {
...
entryRuleValidState returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getValidStateRule()); } 
	 iv_ruleValidState=ruleValidState 
	 { $current=$iv_ruleValidState.current.getText(); }  
	 EOF 
;

// Rule ValidState
ruleValidState returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(    this_ID_0=RULE_ID    {
...
entryRuleValidCommand returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getValidCommandRule()); } 
	 iv_ruleValidCommand=ruleValidCommand 
	 { $current=$iv_ruleValidCommand.current.getText(); }  
	 EOF 
;

// Rule ValidCommand
ruleValidCommand returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(    this_ID_0=RULE_ID    {
