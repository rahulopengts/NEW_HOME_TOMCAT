	...
	public void activate() {			    
        try {
        	...
        	BundleContext bundleContext = FrameworkUtil.getBundle(this.getClass())
                    .getBundleContext();
        	try {
        		System.out.println("\nRESTApplication->activate->start");
    		...
    		Servlet atmosphereServlet = null;//new AtmosphereServlet();
    		System.out.println("\nRESTApplication->activate->httpPost->"+httpPort+"->sslport->"+httpSSLPort);
