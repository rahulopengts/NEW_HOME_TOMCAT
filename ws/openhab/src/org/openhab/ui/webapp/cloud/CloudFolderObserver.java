			...
			if(FileUtils.isFileNewer(file, timeLastCheck)) {
				if(modelRepo!=null) {
					try {
						...
						if(modelRepo.addOrRefreshModelCloud(file.getName(), FileUtils.openInputStream(file))) {
...
//					}
	...
	private File getFolder(String foldername) {
		...
		//String configFileRootFolder	=	"D:\\Home_Auto\\NEW_HOME_TOMCAT\\eclipse\\tomcatappconf";
		String configFileRootFolder	=	"D:\\Home_Auto\\NEW_HOME_TOMCAT\\eclipse\\tomcatappconf\\"+homeName;
