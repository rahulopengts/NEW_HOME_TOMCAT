...
public class ModelRepositoryImpl implements ModelRepository {
	...
	public ModelRepositoryImpl() {
		System.out.println("\n ModelRepositoryImpl->Constructor");
...
//				//System.out.println("\nModelRepositoryImpl->getModel(String name)->resouce null "+name+":instance:"+getName());
	...
	public boolean addOrRefreshModel(String name, InputStream inputStream) {
		System.out.println("\n***ModelrepositoryImpl->addOrRefreshModel->Adding for "+name+":Stream->:"+inputStream);
		Resource resource = getResource(name);
		//Resource resource = null;
		System.out.println("\n***ModelrepositoryImpl->addOrRefreshModel->Adding for "+name+":Resource->:"+resource);
		if(resource==null) {
			synchronized(resourceSet) {
	...
	public boolean addOrRefreshModelCloud(String name, InputStream inputStream) {
		System.out.println("\n***ModelrepositoryImpl->addOrRefreshModel->Adding for "+name+":Stream->:"+inputStream);
...
//						//System.out.println("\n"+Thread.currentThread()+"ModelRepositoryImpl->getAllModelNamedofType->apply->false"+"-this->"+this+"name "+name);
	...
	private Resource getResource(String name) {
		//name	=	"tomcatappconf\\"+name;
		URI	u	=	URI.createURI(name);
		System.out.println("\n ModelRepositoryImpl->getResource->name->"+name+"->URI->"+u);
		
		 return resourceSet.getResource(URI.createURI(name), true);
	}
