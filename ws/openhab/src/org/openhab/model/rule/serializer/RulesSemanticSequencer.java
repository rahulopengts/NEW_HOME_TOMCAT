package org.openhab.model.rule.serializer;
...
import org.openhab.model.script.serializer.ScriptSemanticSequencer;
...
public class RulesSemanticSequencer extends ScriptSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == RulesPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case RulesPackage.CHANGED_EVENT_TRIGGER:
				if(context == grammarAccess.getChangedEventTriggerRule() ||
				   context == grammarAccess.getEventTriggerRule()) {
					sequence_ChangedEventTrigger(context, (ChangedEventTrigger) semanticObject); 
					return; 
				}
				else break;
			case RulesPackage.COMMAND_EVENT_TRIGGER:
				if(context == grammarAccess.getCommandEventTriggerRule() ||
				   context == grammarAccess.getEventTriggerRule()) {
			...
			case RulesPackage.RULE_MODEL:
				if(context == grammarAccess.getRuleModelRule()) {
					sequence_RuleModel(context, (RuleModel) semanticObject); 
					return; 
				}
				else break;
			case RulesPackage.SYSTEM_ON_SHUTDOWN_TRIGGER:
				if(context == grammarAccess.getEventTriggerRule() ||
				   context == grammarAccess.getSystemOnShutdownTriggerRule() ||
				   context == grammarAccess.getSystemTriggerRule()) {
			...
			case RulesPackage.SYSTEM_ON_STARTUP_TRIGGER:
				if(context == grammarAccess.getEventTriggerRule() ||
				   context == grammarAccess.getSystemOnStartupTriggerRule() ||
				   context == grammarAccess.getSystemTriggerRule()) {
			...
			case RulesPackage.TIMER_TRIGGER:
				if(context == grammarAccess.getEventTriggerRule() ||
				   context == grammarAccess.getTimerTriggerRule()) {
			...
			case RulesPackage.UPDATE_EVENT_TRIGGER:
				if(context == grammarAccess.getEventTriggerRule() ||
				   context == grammarAccess.getUpdateEventTriggerRule()) {
					sequence_UpdateEventTrigger(context, (UpdateEventTrigger) semanticObject); 
					return; 
				}
				else break;
			}
		else if(semanticObject.eClass().getEPackage() == ScriptPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
	 ...
	 */
	protected void sequence_ChangedEventTrigger(EObject context, ChangedEventTrigger semanticObject) {
	 ...
	 */
	protected void sequence_CommandEventTrigger(EObject context, CommandEventTrigger semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_RuleModel(EObject context, RuleModel semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_SystemOnShutdownTrigger(EObject context, SystemOnShutdownTrigger semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_SystemOnStartupTrigger(EObject context, SystemOnStartupTrigger semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_TimerTrigger(EObject context, TimerTrigger semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_UpdateEventTrigger(EObject context, UpdateEventTrigger semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
}
