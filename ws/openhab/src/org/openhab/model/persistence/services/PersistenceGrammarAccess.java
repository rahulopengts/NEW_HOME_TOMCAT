...
package org.openhab.model.persistence.services;
...
public class PersistenceGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class CronStrategyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "CronStrategy");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FilterDetailsElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "FilterDetails");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ThresholdFilterElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ThresholdFilter");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TimeFilterElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "TimeFilter");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PersistenceConfigurationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "PersistenceConfiguration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AllConfigElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "AllConfig");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ItemConfigElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ItemConfig");
	...
	public class GroupConfigElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "GroupConfig");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private CronStrategyElements pCronStrategy;
	private FilterElements pFilter;
	private FilterDetailsElements pFilterDetails;
	private ThresholdFilterElements pThresholdFilter;
	private TimeFilterElements pTimeFilter;
	private PersistenceConfigurationElements pPersistenceConfiguration;
	private AllConfigElements pAllConfig;
	private ItemConfigElements pItemConfig;
	private GroupConfigElements pGroupConfig;
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.openhab.model.persistence.Persistence".equals(grammar.getName())) {
				return grammar;
			}
	...
	public CronStrategyElements getCronStrategyAccess() {
		return (pCronStrategy != null) ? pCronStrategy : (pCronStrategy = new CronStrategyElements());
	}
	...
	public FilterDetailsElements getFilterDetailsAccess() {
		return (pFilterDetails != null) ? pFilterDetails : (pFilterDetails = new FilterDetailsElements());
	}
	...
	public ThresholdFilterElements getThresholdFilterAccess() {
		return (pThresholdFilter != null) ? pThresholdFilter : (pThresholdFilter = new ThresholdFilterElements());
	}
	...
	public TimeFilterElements getTimeFilterAccess() {
		return (pTimeFilter != null) ? pTimeFilter : (pTimeFilter = new TimeFilterElements());
	}
	...
	public PersistenceConfigurationElements getPersistenceConfigurationAccess() {
		return (pPersistenceConfiguration != null) ? pPersistenceConfiguration : (pPersistenceConfiguration = new PersistenceConfigurationElements());
	}
	...
	public AllConfigElements getAllConfigAccess() {
		return (pAllConfig != null) ? pAllConfig : (pAllConfig = new AllConfigElements());
	}
	...
	public ItemConfigElements getItemConfigAccess() {
		return (pItemConfig != null) ? pItemConfig : (pItemConfig = new ItemConfigElements());
	}
	...
	public GroupConfigElements getGroupConfigAccess() {
		return (pGroupConfig != null) ? pGroupConfig : (pGroupConfig = new GroupConfigElements());
	}
