 ...
 * <ul>
 *   <li>{@link org.openhab.model.sitemap.impl.SelectionImpl#getMappings <em>Mappings</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SelectionImpl extends NonLinkableWidgetImpl implements Selection
{
  ...
  public EList<Mapping> getMappings()
  {
    if (mappings == null)
    {
      mappings = new EObjectContainmentEList<Mapping>(Mapping.class, this, SitemapPackage.SELECTION__MAPPINGS);
    }
    return mappings;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SitemapPackage.SELECTION__MAPPINGS:
