...
public interface ItemsPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the attribute list '{@link org.openhab.model.items.ModelItem#getGroups <em>Groups</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute MODEL_ITEM__GROUPS = eINSTANCE.getModelItem_Groups();
