package org.openhab.model.script.serializer;
...
public class ScriptSyntacticSequencer extends AbstractSyntacticSequencer {

	protected ScriptGrammarAccess grammarAccess;
	protected AbstractElementAlias match_Script_SemicolonKeyword_2_1_q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (ScriptGrammarAccess) access;
		match_Script_SemicolonKeyword_2_1_q = new TokenAlias(false, true, grammarAccess.getScriptAccess().getSemicolonKeyword_2_1());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_Script_SemicolonKeyword_2_1_q.equals(syntax))
				emit_Script_SemicolonKeyword_2_1_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     ';'?
	 */
	protected void emit_Script_SemicolonKeyword_2_1_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
