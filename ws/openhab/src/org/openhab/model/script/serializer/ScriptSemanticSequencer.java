...
public class ScriptSemanticSequencer extends XbaseSemanticSequencer {

	@Inject
	private ScriptGrammarAccess grammarAccess;
	
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ScriptPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
